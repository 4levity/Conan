package info.jlibrarian.mediatree; /* (c) 2013 C. Ivan Cooper. Licensed under GPLv3, see file COPYING for terms. */

/* Determine info about image files without loading entire file
 * 
 * Original author information below
 * 
 * Modifications:
 * - parameterize Vector to remove warnings
 * - comment out main() method, suppress warnings on unused imports/methods
 */
...
/*	public static final int COLOR_TYPE_UNKNOWN = -1;
	...
	/* Uncomment to use ImageInfo as a standalone program:
